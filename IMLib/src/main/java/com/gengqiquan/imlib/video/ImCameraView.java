...
import com.gengqiquan.imlib.video.listener.*;
import com.gengqiquan.imlib.video.state.CameraMachine;
import com.gengqiquan.imlib.video.util.FileUtil;
import com.gengqiquan.imlib.video.util.LogUtil;
import com.gengqiquan.imlib.video.util.ScreenUtil;
import com.gengqiquan.imlib.video.view.CameraView;
import com.gengqiquan.imui.help.IMHelp;

import java.io.IOException;

public class ImCameraView extends FrameLayout implements CameraInterface.CameraOpenOverCallback, SurfaceHolder
        .Callback, CameraView {
//    private static final String TAG = "JCameraView";
    ...
    //回调监听
    private MediaTakeListener jCameraLisenter;
    ...
    public ImCameraView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mContext = context;
        //get AttributeSet
        TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.ImCameraView, defStyleAttr, 0);
        iconSize = a.getDimensionPixelSize(R.styleable.ImCameraView_iconSize, (int) TypedValue.applyDimension(
    ...
    private void initView() {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.im_camera_view, this);
...
//        });
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        new Thread() {
            @Override
            public void run() {
                CameraInterface.getInstance().doOpenCamera(ImCameraView.this);
            }
        }.start();
    }
...
//                    Log.i("CJT", "result = " + (result - firstTouchLength));
    ...
    public void setJCameraLisenter(MediaTakeListener jCameraLisenter) {
